...
import classes from './CadastroEmpresa.module.css';
...
import { Rectangle2Icon7 } from './Rectangle2Icon7.js';
...
/* @figmaId 39:348 */
export const CadastroEmpresa: FC<Props> = memo(function CadastroEmpresa(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.localizacao}>Localização</div>
      ...
      <div className={classes.rectangle27}>
        <Rectangle2Icon7 className={classes.icon8} />
      </div>
      <div className={classes.check_circle7}>check_circle</div>
      <div className={classes.cNPJ}>CNPJ</div>
